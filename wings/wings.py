...
try:
        ...
        while True:
            ...
            if ques.lower() == "e":
                ...
                if sec == 1:
                    ...
                    subprocess.call(["clear"])
                    print("Dünyada ki aktif hasta sayısı: ", covid.get_total_active_cases())
                    print("Dünyada ki toplam vaka sayısı: ", covid.get_total_recovered())
    ...
    print(
        """
        1)netdiscover                       18)IP_INFORMATION                              99)çıkış  
        2)nikto                             19)YouTube video indirici
        ...
        17)url scraper                      34)Canın mı sıkıldı? Buraya gir ;)
        """
    )
    secim = int(input("Seçiminizi Girin : "))
